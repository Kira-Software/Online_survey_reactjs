...
export const loaduser = () => async dispatch => {
  ...
  try {
    const res = await axios.get("https://survey-express-project.herokuapp.comhttps://survey-express-project.herokuapp.com/https://survey-express-project.herokuapp.com/api/auth");
    dispatch({
      type: USER_LOADED,
      payload: res.data
    });
...
export const register = ({
  ...
  try {
    ...
    const res = await axios.post("https://survey-express-project.herokuapp.comhttps://survey-express-project.herokuapp.com/https://survey-express-project.herokuapp.com/api/user", body, config);
...
export const updateuser = ({
  ...
  try {
    ...
    const res = await axios.post("https://survey-express-project.herokuapp.comhttps://survey-express-project.herokuapp.com/https://survey-express-project.herokuapp.com/api/updateprofile", body, config);
...
export const login = (username, password) => async dispatch => {
  ...
  try {
    ...
    const res = await axios.post("https://survey-express-project.herokuapp.comhttps://survey-express-project.herokuapp.com/https://survey-express-project.herokuapp.com/api/auth", body, config);
...
export const addsurvey = ({
  ...
  try {
    ...
    const res = await axios.post("https://survey-express-project.herokuapp.comhttps://survey-express-project.herokuapp.com/https://survey-express-project.herokuapp.com/api/survey", body, config);
...
export const getmysurvey = () => async dispatch => {
  ...
  //dispatch(loaduser());
  try {
    const res = await axios.get(`https://survey-express-project.herokuapp.comhttps://survey-express-project.herokuapp.com/https://survey-express-project.herokuapp.com/api/survey`);
...
export const getsurveytofill = () => async dispatch => {
  ...
  try {
    const res = await axios.get(`https://survey-express-project.herokuapp.comhttps://survey-express-project.herokuapp.com/https://survey-express-project.herokuapp.com/api/givemesurvey`);
...
export const addchoice = ({ theqid, myanswers }) => async dispatch => {
  ...
  try {
    ...
    const res = await axios.post(`https://survey-express-project.herokuapp.comhttps://survey-express-project.herokuapp.com/https://survey-express-project.herokuapp.com/api/postchoice/${theqid}`, body, config);
...
export const getallchoices = () => async dispatch => {
  ...
  try {
    const res = await axios.get(`https://survey-express-project.herokuapp.comhttps://survey-express-project.herokuapp.com/https://survey-express-project.herokuapp.com/api/issubmitted`);
...
export const deletemysurvey = id => async dispatch => {
  ...
  try {
    await axios.get(`https://survey-express-project.herokuapp.comhttps://survey-express-project.herokuapp.com/https://survey-express-project.herokuapp.com/api/deletesurvey/${id}`);
